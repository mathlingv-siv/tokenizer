...
class Context_Window(object):
    ...
    def extend_window(self):
        ...
        left_pattern = re.compile(r'[A-ZА-Я] [.!?]')
        right_pattern = re.compile(r'[.!?] [A-ZА-Я]')
    ...
    def highlight(self):
        ...
        # use reversed to avoid shifts in positions
...
def main():    
    ...
    today = engine.search_highlighted_context('test required', 3)
