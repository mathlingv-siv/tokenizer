...
class TestContextWindows(unittest.TestCase):
    ...
    def test_mcw_twowords_one(self):
        ...
        result = self.s.search_multiple_contexts(query, 1)
        output = {'test.txt': [Context_Window(Position_with_lines(10, 14, 0), 8, 27, 'this is a test required for helping students create a test\n'),
                               Context_Window(Position_with_lines(54, 58, 0), 52, 58, 'this is a test required for helping students create a test\n'),
                               Context_Window(Position_with_lines(11, 19, 1), 1, 22, ' professor required to write a test first'),
                               Context_Window(Position_with_lines(31, 35, 1), 29, 41, ' professor required to write a test first')],
                  'tst.txt': [Context_Window(Position_with_lines(0, 4, 0), 0, 20, 'test is required. On the other hand...')]}
        self.assertEqual(result, output)
    ...
    def test_mcw_two(self):
        ...
        output = {'test.txt': [Context_Window(Position_with_lines(10, 14, 0), 5, 35, 'this is a test required for helping students create a test\n'),
                               Context_Window(Position_with_lines(54, 58, 0), 45, 58, 'this is a test required for helping students create a test\n'),
                               Context_Window(Position_with_lines(11, 19, 1), 1, 41, ' professor required to write a test first')],
                  'tst.txt': [Context_Window(Position_with_lines(0, 4, 0), 0, 24, 'test is required. On the other hand...')]}
        self.assertEqual(result, output)

    def test_cw_one_token(self):
        """test if the program is working correctly
        when searching for a context of a word with window = 1
    ...
    def test_cw_one_null(self):
        """test if the program is working correctly
        when searching for a context of a word with window = 0
    ...
    def test_cw_one_out_of_range(self):
        """test if the program is working correctly
        when searching for a context of a word with window > text length
    ...
    def test_cw_two_one_token(self):
        """test if the program is working correctly
        when searching for a context of a word with window = 2
    ...
    def test_cw_three_one_token(self):
        """test if the program is working correctly
        when searching for a context of a word with window = 3
    ...
    def test_cw_no_left_one_token(self):
        """test if the program is working correctly
        when searching for a context of a word with no left context
    ...
    def test_cw_no_right_one_token(self):
        """test if the program is working correctly
        when searching for a context of a word with no right context
    ...
    def test_cw_position_end_error(self):
        """test if the program is working correctly
        when searching for a context of a word with error in its end position
    ...
    def test_cw_start_equal_end(self):
        """test if the program is working correctly
        when searching for a context of a word with start position = end position
    ...
    def test_cw_line_error(self):
        """test if the program is working correctly
        when searching for a context of a word with error in its line number
    ...
    def test_cw_line_neg_error(self):
        """test if the program is working correctly
        when searching for a context of a word with a negative line number
    ...
    def test_cw_no_word_error(self):
        """test if the program is working correctly
        when searching for a context of a position that does not correspond to any word
    ...
    def test_cw_filename_error(self):
        """test if the program is working correctly
        when searching for a context of a word with error in its filename
