...
class TestContextWindows(unittest.TestCase):
    ...
    #acceleration
    def test_limit_offset_more_pairs(self):
        """test if the program is working correctly
        when there are more requirements for quotes in files
        than there are files
        """
        result = self.s.limit_quote_context_search("test", 2, 0, [(1, 1), (1, 0), (1, 0), (1, 0)])
        output = {'test.txt': [' professor required to write a <b>test</b> first'],
                  'tst.txt': ['<b>test</b> is required.']}
        self.assertEqual(result, output)

    def test_limit_offset_quote(self):
        """test if the program is working correctly
        when searching for a specified number of
        contexts windows in a specified number of files        
        """
        result = self.s.limit_quote_context_search("test", 1, 0, [(1, 0)])
        output = {'test.txt': ['this is a <b>test</b> required for helping students create a <b>test</b>']}
        self.assertEqual(result, output)

    def test_limit_offset_quote2(self):
        """test if the program is working correctly
        when searching for a specified number of
        contexts windows in a specified number of files        
        """
        result = self.s.limit_quote_context_search("test required", 2, 0, [(1, 0), (1, 0)])
        output = {'test.txt': ['this is a <b>test</b> <b>required</b> for helping students create a <b>test</b>'],
                  'tst.txt': ['<b>test</b> is <b>required</b>. On the other hand...']}
        self.assertEqual(result, output)
        
    def test_limit_offset_quote_neglim(self):
        """test if the program is working correctly
        when searching for a specified number of
        contexts windows in a specified number of files with a negative value of limit       
        """
        result = self.s.limit_quote_context_search("test", -2, 0, [(1, 0)])
        output = {}
        self.assertEqual(result, output)
        
    def test_limit_offset_quote_neg(self):
        """test if the program is working correctly
        when searching for a specified number of
        contexts windows in a specified number of files with a negative value of offset       
        """
        result = self.s.limit_quote_context_search("test", 1, -2, [(1, 0)])
        output = {'test.txt': ['this is a <b>test</b> required for helping students create a <b>test</b>']}
        self.assertEqual(result, output)
        
    def test_limit_offset_doc(self):
        """test if the program is working correctly
        when searching for contexts windows
        in a specified number of files (one)
        starting from the second one
        """
        result = self.s.limit_offset_search("test required", 1, 1)
        output = {'tst.txt': ['<b>test</b> is <b>required</b>. On the other hand...']}
        self.assertEqual(result, output)

    def test_limit_hcw(self):
        """test if the program is working correctly
        when searching for contexts windows
        with the searched words highlighted
        
        """
        result = self.s.limit_search_highlighted_context('test required', 2, 1, 1)
        output = {'tst.txt': ['<b>test</b> is <b>required</b>. On the']}
        self.assertEqual(result, output)
    ...
    def test_limit_search_multiple_one_token2(self):
        """test if engine for multiple word search
        is working correctly when searching for one word
        
        """
        result = self.s.limit_search_multiple('test', 2, 1)
        self.assertEqual(result, {'tst.txt': [Position_with_lines(0, 4, 0)]})
    ...
    def test_limit_quote(self):
        ...
        contexts windows in a specified number of files        
        """
        result = self.s.limit_quote_search("test", 1, 0, [(1, 0)])
        output = {'test.txt': ['this is a <b>test</b> required for helping students create a <b>test</b>']}
        self.assertEqual(result, output)

    def test_limit_quote_two(self):
        """test if the program is working correctly
        when searching for two contexts windows
        in a specified number of files        
        """
        result = self.s.limit_quote_search("test", 2, 0, [(1, 1), (1, 0)])
        output = {'test.txt': [' professor required to write a <b>test</b> first'],
                  'tst.txt': ['<b>test</b> is required.']}
        self.assertEqual(result, output)

    def test_limit_quote_more(self):
        """test if the program is working correctly
        when searching for more contexts windows than there are in the files        
        """
        result = self.s.limit_quote_search("test", 1, 0, [(3, 0)])
        output = {'test.txt': ['this is a <b>test</b> required for helping students create a <b>test</b>',
                               ' professor required to write a <b>test</b> first']}
        self.assertEqual(result, output)

    def test_limit_quote_more_again(self):
        """test if the program is working correctly
        when searching for more contexts windows than there are in the files        
        """
    ...
    def test_limit_quote_less(self):
        """test if the program is working correctly
        when searching for contexts windows starting from
    ...
    def test_limit_quote_more_pairs(self):
        """test if the program is working correctly
        when there are more requirements for quotes in files
        than there are files
        """
        result = self.s.limit_quote_search("test", 2, 0, [(1, 1), (1, 0), (1, 0), (1, 0)])
        output = {'test.txt': [' professor required to write a <b>test</b> first'],
                  'tst.txt': ['<b>test</b> is required.']}
        self.assertEqual(result, output)
    ...
    def test_limit_doc(self):
        ...
        starting from the second one
        """
        result = self.s.limit_search("test required", 1, 1)
        output = {'tst.txt': ['<b>test</b> is <b>required</b>. On the other hand...']}
        self.assertEqual(result, output)

    def test_limit_two_docs(self):
        """test if the program is working correctly
        when searching for contexts windows
        in a specified number of files (two)
        starting from the second one out of the two
        """
        result = self.s.limit_search("test", 2, 1)
        output = {'tst.txt': ['<b>test</b> is required.']}
        self.assertEqual(result, output)
    ...
    def tearDown(self):
        del self.s
        for filename in os.listdir(os.getcwd()):            
            if filename == 'dbase' or filename.startswith('dbase.'):
                os.remove(filename)        
